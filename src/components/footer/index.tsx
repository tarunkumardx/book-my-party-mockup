...
import { FooterLogo, MassesIcon, WhatsappIcon } from '@/assets/images'
						...
						loadingFooter ?
							...
							<div className="main-footer">
								...
								<div className="page-container">
									...
									<button type="button" className="btn phone border-0 p-0" data-bs-toggle="modal" data-bs-target="#EnquiryNowModal">

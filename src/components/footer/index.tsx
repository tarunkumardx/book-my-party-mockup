				...
				<footer>
					...
					<div className="d-md-none w-full mobFooter text-center">
						<ul className="d-flex">
							...
							<li style={{ fontSize: '12px' }}><Link href="https://mockup4clients.com/corporate-gifting"><Image src={CorporateGiftColored} width="40" height="40" alt="Phone" className="" /></Link><Link href="/Coming-soon">Corporate Gifting</Link></li>
